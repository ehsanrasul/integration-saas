...
//       onChange={handlePasswordChange}
//     />
//          <SignInButton variant="warning" type="submit" >
//           Sign In
//         </SignInButton> 
//   </SignInBox>
// </form>
...
const Login = () => {
  ...
  const SocialMButtons = {
    color: "#333",
    border: "none",
    padding: "10px 20px",
  };

  const signInBoxHeadingStyle = {
    marginBottom: "20px",
    color: "#333",
  };
  ...
  return (
    <div style={signInBoxStyle}>
      <h2 style={signInBoxHeadingStyle}>Sign In</h2>
      <form onSubmit={handleSignInClick}>
        <div style={formGroupStyle}>

        </div>
        <div style={formGroupStyle}>
          <input type="text" name="email" placeholder="Enter your email " value={email} onChange={handleEmailChange} style={inputStyle} />
        </div>
        <div style={formGroupStyle}>
          <input type="password" name="password" placeholder="Enter your Password" value={password} onChange={handlePasswordChange} style={inputStyle} />
        </div>
        <div style={formGroupStyle}>
          <button type="submit" style={submitButtonStyle}>Sign In</button>
        </div>
      </form>
      <div style={otherOptionsStyle}>
    </div>
      <a href="/login-option" style={{"textDecoration": "none"}} >Dont have an Account ? <strong>Create one</strong> </a>
    </div>
  );
}
